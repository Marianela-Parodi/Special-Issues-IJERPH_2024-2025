...
write.csv(si, file = "/workspaces/R/datos/SI_ijerph_all_2025.csv", row.names = FALSE)
```
...
for (i in seq(1, dim(SIs_ijerph)[1], by = max_por_archivo)) {
  ...
  filename <- paste0("/workspaces/R/datos/SI_guest_editor_info_", i, "to", min(i + max_por_archivo - 1, dim(SIs_ijerph)[1]), ".csv")
