...
# saco la información para cada artículo
ijerph_articles<-read.csv("/workspaces/R/datos/all_ijerph_articles.csv")
article_info_ijerph_45000_49999<-article_info_modificado(ijerph_articles, sample=45000:49999) 
write.csv(article_info_ijerph_45000_49999, file = "/workspaces/R/datos/article_info_ijerph_45000_49999.csv", row.names = FALSE)
```
