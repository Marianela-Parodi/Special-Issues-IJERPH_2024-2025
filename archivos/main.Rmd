...
# saco la información para cada artículo
ijerph_articles<-read.csv("/workspaces/R/datos/all_ijerph_articles.csv")
article_info_ijerph_35000_39999<-article_info_modificado(ijerph_articles, sample=35000:39999) 
write.csv(article_info_ijerph_35000_39999, file = "/workspaces/R/datos/article_info_ijerph_35000_39999.csv", row.names = FALSE)
```
