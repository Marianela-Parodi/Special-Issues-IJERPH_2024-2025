...
# saco la información para cada artículo
ijerph_articles<-read.csv("/workspaces/R/datos/all_ijerph_articles.csv")
article_info_ijerph_20000_24999<-article_info_modificado(ijerph_articles, sample=20000:24999) 
write.csv(article_info_ijerph_20000_24999, file = "/workspaces/R/datos/article_info_ijerph_20000_24999.csv", row.names = FALSE)
```
